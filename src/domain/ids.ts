...
export type StaffOfferId = Brand<string, "StaffOfferId">;
...
export function asStaffOfferId(value: string): StaffOfferId {
  return value as StaffOfferId;
}
...
export function asMediaItemId(value: string): MediaItemId {
